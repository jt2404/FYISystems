      ...
      <section className="container">
        <div className="about-us-content">
          ...
          <div className="image-content">
            <img className="about-img-1"  src={`http://3.128.53.252:3001${homePage?.aboutSection?.bigImageUrl}`} alt="About 1" />
            <img className="about-img-2"  src={`http://3.128.53.252:3001${homePage?.aboutSection?.smallImageUrl}`} alt="About 2" />
          </div>
