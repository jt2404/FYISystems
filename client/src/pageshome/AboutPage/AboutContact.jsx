          ...
          <div className="contact-form">
            <div>
              <h5 className="contact-title">
                Ready to take control of your financial future? Our team of seasoned experts is here
                to guide you every step of the way. Fill out the form below to get in touch with us
                today!
              </h5>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-inputs">
                <div className="type_1">
                  <label for="YourPhone" className="form-label">
                    Your Phone
                  </label>
                  <input
                    type="number"
