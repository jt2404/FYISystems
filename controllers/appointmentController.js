...
exports.createAppointment = async (req, res) => {
  try {
    const { userName, productId, financialAdvisorId, date, startTime, endTime,emai,phone } =
      req.body;
...
exports.updateAppointment = async (req, res) => {
  try {
    const { userName,financialAdvisorId, status , date, startTime, endTime,email,phone } = req.body;
    ...
    const updatedAppointment = await Appointment.findByIdAndUpdate(
      req.params.id,
      {
        ...
        userName: userName || existingAppointment.userName,
